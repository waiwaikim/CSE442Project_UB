...
function runTestSubmissionSQL($email){
    ...
    echo "Test writeSubmission()";
    writeSubmission ('LukeMcDa@buffalo.edu', 'JacobSie@buffalo.edu', 1, 2, 3, 2, 1);
    echo "<br><br>";
    
    
    /*---------------Test getTeammates() --------------------*/
    echo "Test getTeammates() ";
